...
//             MP3Track* mp3_track = new MP3Track(track_info.title, track_info.artists, track_info.duration_seconds, track_info.bpm, track_info.extra_param1, track_info.extra_param2);
//             std::cout << "MP3Track created: " << mp3_track->get_bitrate() << "kbps" << std::endl;
//             created_track = mp3_track;
//         }
//         else if(track_info.type == "WAV"){
//             WAVTrack* wav_track  = new WAVTrack(track_info.title, track_info.artists, track_info.duration_seconds, track_info.bpm, track_info.extra_param1, track_info.extra_param2);
//             std::cout << "[WAVTrack created: " << wav_track->get_sample_rate() << "Hz/" << wav_track->get_bit_depth() << "bit" << std::endl;
//             created_track = wav_track;
//         } 
//         if(created_track){
